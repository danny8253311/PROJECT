...
namespace WebSiteTest.Areas.supplier.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(ComperWebSiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Suppliers != null ? 
                          ...
                          Problem("Entity set 'ComperWebSiteContext.Suppliers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("SupplierId,CompanyName,Address,Phone,ContactPerson,Email,Bank,Account,UniformNumbers")] Suppliers suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplierId,CompanyName,Address,Phone,ContactPerson,Email,Bank,Account,UniformNumbers")] Suppliers suppliers)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ComperWebSiteContext.Suppliers'  is null.");
            }
            var suppliers = await _context.Suppliers.FindAsync(id);
            if (suppliers != null)
            {
